                    ...
                    <div class="card-body">
                        <form action="{{ route('bgh.update', $bgh->id) }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="nama_kegiatan" value="{{ $bgh->nama_kegiatan }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="thn_anggaran" value="{{ $bgh->thn_anggaran }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="sumber_anggaran" value="{{ $bgh->sumber_anggaran }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="alokasi_anggaran" value="{{ $bgh->alokasi_anggaran }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="volume_pekerjaan" value="{{ $bgh->volume_pekerjaan }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="status_aset" value="{{ $bgh->status_aset }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="instansi_unit_organisasi_pelaksana" value="{{ $bgh->instansi_unit_organisasi_pelaksana }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="lokasi_kegiatan_proyek" value="{{ $bgh->lokasi_kegiatan_proyek }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="nama_kepala_dinas" value="{{ $bgh->nama_kepala_dinas }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="nama_pengelola" value="{{ $bgh->nama_pengelola }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="nama_penyedia_jasa_perencanaan" value="{{ $bgh->nama_penyedia_jasa_perencanaan }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="thn_penerbitan_sertifikat_bgh" value="{{ $bgh->thn_penerbitan_sertifikat_bgh }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="no_sertifikat_bgh" value="{{ $bgh->no_sertifikat_bgh }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="no_plakat_bgh" value="{{ $bgh->no_plakat_bgh }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="thn_penerbitan_sertifikat_pemanfaatan_bgh" value="{{ $bgh->thn_penerbitan_sertifikat_pemanfaatan_bgh }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="peringkat_bgh" value="{{ $bgh->peringkat_bgh }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" disabled name="pemanfaatan_ke" value="{{ $bgh->pemanfaatan_ke }}"
