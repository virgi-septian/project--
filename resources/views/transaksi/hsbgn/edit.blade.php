                    ...
                    <div class="card-body">
                        <form action="{{ route('hsbgn.update', $hsbgn->id) }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_kecamatan" value="{{ $hsbgn->nama_kecamatan }}"
                            ...
                            <div class="mb-3">
                                <label for="">Nama Kecamatan</label>
                                <input type="text" name="angka_luas_wilayah" value="{{ $hsbgn->angka_luas_wilayah }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="satuan_luas_wilayah" value="{{ $hsbgn->satuan_luas_wilayah }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="zona" value="{{ $hsbgn->zona }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="bg_tidak_sederhana" value="{{ $hsbgn->bg_tidak_sederhana }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="bg_sederhana" value="{{ $hsbgn->bg_sederhana }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="rumahnegara_tipe_a" value="{{ $hsbgn->rumahnegara_tipe_a }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="rumahnegara_tipe_b" value="{{ $hsbgn->rumahnegara_tipe_b }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="rumahnegara_tipe_c_d_e" value="{{ $hsbgn->rumahnegara_tipe_c_d_e }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="pagar_gedungnegara_depan" value="{{ $hsbgn->pagar_gedungnegara_depan }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="pagar_gedungnegara_samping" value="{{ $hsbgn->pagar_gedungnegara_samping }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="pagar_gedungnegara_belakang" value="{{ $hsbgn->pagar_gedungnegara_belakang }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="pagar_rumahnegara_depan" value="{{ $hsbgn->pagar_rumahnegara_depan }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="pagar_rumahnegara_samping" value="{{ $hsbgn->pagar_rumahnegara_samping }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="pagar_rumahnegara_belakang" value="{{ $hsbgn->pagar_rumahnegara_belakang }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="sk_penetapan"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="indeks_kemahalan_konstruksi" value="{{ $hsbgn->indeks_kemahalan_konstruksi }}"
                            ...
                            <center>
                                <div class="btn-group mt-4 pt-5" role="group" aria-label="Basic mixed styles example">
                                    ...
                                    <a href="{{ route('hsbgn.index') }}" class="btn btn-danger">Batal</a>
                                </div>
                            </center>
                        </form>
                    </div>
